...
{
    class Middle : IEngineer
    {
        private static string _title = "Middle Developer";
        private static short _titleImportance = 1;
        ...
        public Middle(string first, string last, byte exp,
